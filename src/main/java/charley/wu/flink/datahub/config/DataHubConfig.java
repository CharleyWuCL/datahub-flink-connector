...
public class DataHubConfig implements Serializable {
  ...
  public static final String PROXY_PCODE = "datahub.http.proxyPcode";  // 代理服务器验证的密码
  ...
  public static final String BATCH_ENABLE = "datahub.sink.batchEnable";  // 是否批量发送
  ...
  public HttpConfig buildHttpConfig() {
    ...
    String proxyPassword = prop.getProperty(PROXY_PCODE);
